...
const services = [
  { category: "START YOUR BUSINESS", href: "/services/start-your-business" },
  { category: "PROTECT YOUR BUSINESS", href: "/services/protect-your-business" },
  { category: "MANAGE YOUR BUSINESS", href: "/services/manage-your-business" },
  { category: "REGISTRATIONS & LICENSES", href: "/services/registrations-licenses" },
  { category: "FINANCIAL MANAGEMENT", href: "/services/financial-management" },
  { category: "BUSINESS GROWTH", href: "/services/business-growth" },
  { category: "FRANCHISE ADVISORY", href: "/services/franchise-advisory" },
  { category: "INTERNATIONAL BUSINESS", href: "/services/international-business" },
]
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 py-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {services.map((category) => (
                <div key={category.category}>
                  <Link
                    href={category.href}
                    className="block uppercase pb-1 mb-2 text-sm hover:text-[#6BAE3A]"
